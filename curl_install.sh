...
# iCESugar-nano FPGA Flash Tool - Curl Installer
# This script can be run directly with: bash <(curl -s https://raw.githubusercontent.com/abhinav937/Lattice_NanoIce/main/curl_install.sh)
...
echo "=========================================="
echo "iCESugar-nano FPGA Flash Tool - Curl Installer"
echo "=========================================="
echo ""
